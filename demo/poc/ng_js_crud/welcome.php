...
?>
    ...
    <h3 class = "text-primary">AngularJS CRUD OPERATION WITH PHP/MySQLI</h3>
	...
	<a class = "btn btn-danger" href = "logout.php"><span class = "glyphicon glyphicon-log-out"></span> Logout</a>
        ...
        <form>
         ...
         <td> <center><button type="button" class="btn btn-danger" ng-click = "updateBtn(member.mem_id, member.firstname, member.lastname)" ><span class="glyphicon glyphicon-edit"></span></button>    <button type="button" class=" btn btn-warning" ng-click = "deleteData(member.mem_id);" ><span class="glyphicon glyphicon-remove"></span></button></center>
